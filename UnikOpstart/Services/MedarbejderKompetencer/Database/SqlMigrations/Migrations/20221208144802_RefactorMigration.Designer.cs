...
namespace UnikOpstart.Services.Database.SqlMigrations.Migrations
{
    ...
    [Migration("20221208144802_RefactorMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MedarbejderKompetencer.Domain.Model.KompetenceEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("MedarbejderKompetencer.Domain.Model.KompetenceStoredEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("KompetenceStoredEntities");
                });

            modelBuilder.Entity("MedarbejderKompetencer.Domain.Model.MedarbejderEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
